...
const Navbar = () => {
    ...
    return (
        <>
            {!scrolling &&
                <div className={`w-full px-10 pt-2 fixed top-0 z-[999] text-white bg-none ${scrolling && 'hidden'}`}>
            ...
            {scrolling &&
                <motion.nav
                    ...
                    className={`fixed top-0 left-0 right-0 z-50 ${scrolling ? 'bg-blue-900' : 'bg-transparent'} text-white py-3`}
                >
                    <div className="max-w-screen-lg lg:mx-auto flex flex-row items-center justify-between mx-10 lg:gap-20">
                        <Link href="/">
                            <motion.img
                                src="/logo.png"
                                alt="Logo"
                    ...
                    {menuOpen && (
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.2 }}
                            className="lg:hidden absolute top-full left-0 w-full bg-blue-900 text-white py-4 px-6 flex flex-col items-center justify-center"
                        >
                            <Link href="/" className="hover:text-gray-300">
                                Home
                            </Link>
